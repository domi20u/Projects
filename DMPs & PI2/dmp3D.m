classdef dmp3D
    ...
    properties
        ...
        mass                    %input for dmp
        alpha                   %for computing the exponential phase xs_phase (same for x-, y- and z-direction)
        ...
        x_init                  %Initial point [x,y,z] of the trajectory
        x_end                   %Final point [x,y,z] of the trajectory
    ...
    methods
        ...
        function obj = train(obj,trajectory_file)
            ...
            [obj.mean_z,~,~] = rbfn_fit(obj.n_rbf,f_target(:,3),obj.bf_type);
        end
        ...
        function [y,ydd,y_ball,release_point] = dynamics(obj,meanX,meanY,meanZ,saving,file_out)
            ...
            xs_spring = zeros(obj.n_time_steps,6); %2D for Y and Z parts of first order diff eq
        ...
        function plot_rollout(obj,mean)
            ...
            plot3(-0.4,-0.4,-0.3,'mo','LineWidth',3);
            ...
            if cols == 3*obj.n_rbf
                ...
                %plotting ball curve
                plot3(y_ball(:,1),y_ball(:,2),y_ball(:,3),'--c') 
